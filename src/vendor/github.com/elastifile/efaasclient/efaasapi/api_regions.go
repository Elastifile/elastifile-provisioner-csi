...
/* 
RegionsApiService Retrieves the list of region resources available for service
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListRegionsOpts - Optional Parameters:
...
func (a *RegionsApiService) ListRegions(ctx context.Context, localVarOptionals *ListRegionsOpts) ([]Region, *http.Response, error) {
	var (
