...
const (
	...
	cephConfigFileNameFmt  = "ceph.share.%s.emsConfig"
...
type ecfsConfigData struct {
	// TODO: Remove redundant fields, e.g. Monitors
	Monitors string
	VolumeID volumeID
}
...
func (d *ecfsConfigData) writeToFile() error {
