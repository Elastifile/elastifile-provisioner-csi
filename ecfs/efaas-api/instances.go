...
type Instances struct {
	...
	// Defines the access rights to the File System. This is a listof access rights configured by the client for the file system.
	Accessors Accessors `json:"accessors,omitempty"`

	// Snapshot object
	Snapshot Snapshots `json:"snapshot"`
