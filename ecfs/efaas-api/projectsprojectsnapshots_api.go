 ...
 * @return *Operation
 */
func (a ProjectsprojectsnapshotsApi) CreateInstanceSnapshot(project string, instance string, payload Snapshots, requestId string) (*Operation, *APIResponse, error) {
	...
	var localVarAPIResponse = &APIResponse{Operation: "CreateInstanceSnapshot", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
 ...
 * @return []Snapshots
 */
func (a ProjectsprojectsnapshotsApi) ListSnapshots(project string) ([]Snapshots, *APIResponse, error) {
