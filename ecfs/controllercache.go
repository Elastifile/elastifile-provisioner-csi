...
//		if err != nil {
//			glog.Errorf("ecfs: cloudn't read '%s' from controller cache: %v", fi.Name(), err)
//			continue
//		}
//
//		d := json.NewDecoder(f)
...
//			glog.Errorf("ecfs: failed to parse '%s': %v", fi.Name(), err)
//		} else {
...
//	ent, ok := m[volId]
//	if !ok {
//		glog.Infof("BBBBB controllerCacheMap.pop - volume %v not found. MAP: %+v", volId, m) // TODO: DELME
