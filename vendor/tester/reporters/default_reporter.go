...
func (reporter *DefaultReporter) SpecSuiteWillBegin(config config.TesterConfigType, summary *types.SuiteSummary) {
...
func (reporter *DefaultReporter) SpecSuiteDidEnd(summary *types.SuiteSummary) {
	...
	reporter.stenographer.SummarizeAll(reporter.specSummaries)
