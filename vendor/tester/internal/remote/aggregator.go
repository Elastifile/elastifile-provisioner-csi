...
func (aggregator *Aggregator) SpecSuiteWillBegin(config config.TesterConfigType, summary *types.SuiteSummary) {
...
func (aggregator *Aggregator) registerSuiteEnding(suite *types.SuiteSummary) (finished bool, passed bool) {
	...
	for _, suiteSummary := range aggregator.aggregatedSuiteEndings {
		...
		aggregatedSuiteSummary.NumberOfAbortedSpecs += suiteSummary.NumberOfAbortedSpecs
