...
const (
	...
	VmRestart                               EmEvents = 5020
	SecondaryEmanageJoined                  EmEvents = 5022
)
...
func (e EmEvents) String() string {
	...
	case VmRestart:
		return "Vm restart has been issued"
	case SecondaryEmanageJoined:
		return "Successfully joined secondary Emanage"
	default:
